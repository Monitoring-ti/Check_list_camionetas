...
**Versión:** `1.0.9` · [Changelog](./CHANGELOG.md) · [Arquitectura](./docs/ARCHITECTURE.md) · [Manual de usuario](./docs/MANUAL_USUARIO.md) · [Manual del administrador](./docs/MANUAL_ADMINISTRADOR.md)
